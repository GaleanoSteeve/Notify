    ...
    public class DatLotes
    {
        ...
        public bool Almacenar(ObjLotes oLote)
        {
            ...
            try
            {
                ...
                sqlCommand.Parameters.Add("@NumeroLote", SqlDbType.Int).Value = oLote.NumeroLote;
                sqlCommand.Parameters.Add("@Area", SqlDbType.Int).Value = oLote.Area;
                ...
                sqlCommand.Parameters.Add("@FechaInicioPagoCuotas", SqlDbType.Date).Value = oLote.FechaInicioPagoCuotas;
                sqlCommand.Parameters.Add("@DiaPagoCuota", SqlDbType.Int).Value = oLote.DiaPagoCuota;
