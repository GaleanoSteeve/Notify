    ...
    public class DatConfiguracion
    {
        ...
        public string Guardar(ObjConfiguracion oConfiguracion)
        {
            ...
            try
            {
                ...
                sqlCommand.Parameters.Add("@DiasNotificacion", SqlDbType.Int).Value = oConfiguracion.DiasNotificacion;
                ...
                sqlCommand.Parameters.Add("@IdMunicipio", SqlDbType.VarChar, 10).Value = oConfiguracion.IdMunicipio;
                sqlCommand.Parameters.Add("@Municipio", SqlDbType.VarChar, 100).Value = oConfiguracion.Municipio;
                sqlCommand.Parameters.Add("@IdTipoCuenta", SqlDbType.Int).Value = oConfiguracion.IdTipoCuenta;
                sqlCommand.Parameters.Add("@NumeroCuenta", SqlDbType.BigInt).Value = oConfiguracion.NumeroCuenta;
