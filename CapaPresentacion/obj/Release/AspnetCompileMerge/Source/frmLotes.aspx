        ...
        <div class="table-responsive">
            <asp:GridView ID="gvLotes" runat="server" CssClass="table table-striped table-hover" AutoGenerateColumns="False">
                <Columns>
                    ...
                    <asp:BoundField DataField="Valor" HeaderText="Valor" HeaderStyle-Width="10%" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:N0}" />
                    <asp:BoundField DataField="CuotaInicial" HeaderText="Cuota Inicial" HeaderStyle-Width="10%" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:N0}" />
                    <asp:BoundField DataField="CuotaMensual" HeaderText="Cuota Mensual" HeaderStyle-Width="15%" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:N0}" />
